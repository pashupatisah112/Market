<template>
    <v-container fluid>
                    ...
                    <v-row>
                        <v-col cols="12">
                            ...
                            <h4>
                                ...
                                <v-chip
                                    small
                                    v-for="item in view.color"
                                    :key="item.id"
                                    class="font-weight-light mx-1"
                                    >{{ item.color_name + ", " }}</v-chip
                                >
                            </h4>
                            <h4>
                                Size:
                            ...
                            <h4>
                                Category: <span>{{ view.category }}</span>
                            </h4>
                            ...
                            <v-row justify="center">
                                <div class="mx-auto">
                                    <v-btn
                                        ...
                                        :loading="isSecondarySelecting"
                                    >
                                        <v-icon>mdi-image-plus</v-icon>
                                    </v-btn>
                                    <input
                                        ref="secondaryUploader"
                                        class="d-none"
                                        multiple
                                        type="file"
                                        accept="image/*"
                                        @change="onSecondaryUpload"
                                    />
        ...
        <v-dialog
            v-model="confirmStatusChangeDialog"
            max-width="400"
            persistent
        >
            <v-card>
                ...
                <v-card-text>
                    <v-form v-model="valid" ref="form">
                        <v-select
                            ...
                            placeholder="Change Product Status"
                            item-text="status"
                            item-value="status"
                            dense
                            outlined
                ...
                <v-card-actions>
                    ...
                    <v-btn
                        ...
                        small
                        class="text-capitalize"
                        @click="confirmProductStatusChange"
                        >Confirm</v-btn
                    >
                </v-card-actions>
            </v-card>
