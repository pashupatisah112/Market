...
<div>
    <v-container>
        <v-row justify="center">
            <h2 class="mt-5 text-text-uppercase">{{ $t('words.general.recommendedProducts') }}</h2>
        </v-row>
        <v-row class=" mt-5" v-if="this.recommended.length>0">
                <v-col cols="12" lg="2" md="4" sm="6" v-for="item in recommended" :key="item.id">
