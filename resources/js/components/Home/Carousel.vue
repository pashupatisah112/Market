<template>
<v-carousel cycle class="mt-2">
    <v-carousel-item :show-arrows="arrows" v-for="(item,i) in featured" :key="i" :src="item.photo" reverse-transition="fade-transition" transition="fade-transition">
